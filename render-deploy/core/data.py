...
fbst_yukselenler_cocuk = {
    "Koc": "Dış dünyaya cesur, enerjik ve öncü bir çocuk enerjisiyle çıkar. Keşfetmeyi seven, meraklı ve kendi yolunu çizen bir yapısı vardır.",
    "Boga": "Dış dünyaya sakin, huzurlu ve güvenilir bir çocuk enerjisiyle çıkar. Sevdiklerine sıkı sıkıya bağlanır, güvende hissettiğinde en güzel yanlarını gösterir.",
    "Ikizler": "Dış dünyaya neşeli, meraklı ve iletişimci bir çocuk enerjisiyle çıkar. Soru sormayı sever, her bilgiyi hızla öğrenir ve paylaşır.",
    "Yengec": "Dış dünyaya şefkatli, korumacı ve sezgisel bir çocuk enerjisiyle çıkar. Ailesine ve yuva sıcaklığına derinden bağlıdır.",
    "Aslan": "Dış dünyaya parlak, cömert ve neşeli bir çocuk enerjisiyle çıkar. İlgi görmeyi ve takdir edilmeyi sever, yaratıcılığıyla öne çıkar.",
    "Basak": "Dış dünyaya düzenli, titiz ve yardımsever bir çocuk enerjisiyle çıkar. Detaylara önem verir, öğrenmeye ve pratik çözümler bulmaya yatkındır.",
    "Terazi": "Dış dünyaya uyumlu, zarif ve adaletli bir çocuk enerjisiyle çıkar. Arkadaşlık ilişkilerinde denge ve huzur arar.",
    "Akrep": "Dış dünyaya derin, gizemli ve güçlü bir çocuk enerjisiyle çıkar. Duygularını derinden yaşar, bağlandığı kişilere sadıktır.",
    "Yay": "Dış dünyaya maceracı, iyimser ve özgürlüğüne düşkün bir çocuk enerjisiyle çıkar. Keşfetmeyi, yeni yerler ve yeni fikirler öğrenmeyi sever.",
    "Oglak": "Dış dünyaya olgun, ciddi ve sorumluluk sahibi bir çocuk enerjisiyle çıkar. Hedeflerine odaklanır, disiplinli ve kararlıdır.",
    "Kova": "Dış dünyaya yenilikçi, özgün ve bağımsız bir çocuk enerjisiyle çıkar. Kalıplara sığmaz, kendi fikirlerini özgürce savunur.",
    "Balik": "Dış dünyaya hayalperest, şefkatli ve sezgisel bir çocuk enerjisiyle çıkar. İç dünyası zengindir, sanata ve hayallere derinden bağlıdır."
}

fbst_retrolar_cocuk = {
    "Merkür": "📝 <b>[Karmik Retro Mührü]:</b> <i>Zihinsel içe dönüş! Çocuğun düşünce dünyası dışa dönük olmaktan ziyade derin ve sezgiseldir; söylediklerinden çok hissettikleriyle konuşur.</i>",
    "Venüs": "📝 <b>[Karmik Retro Mührü]:</b> <i>Özdeğer sınavı! Sevgi enerjisi içine dönüktür; çocuk sevgiyi gösterişle değil, derin ve sadık bağlarla yaşar. Geçmişten gelen bir sevgi dersi taşır.</i>",
    "Mars": "📝 <b>[Karmik Retro Mührü]:</b> <i>Eylemin içselleştirilmesi! Öfke ve enerji dışarıya patlamak yerine içsel bir güce dönüşür. Çocuk, gücünü öfkeyle değil, sabırla kullanmayı öğrenir.</i>",
    "Jüpiter": "📝 <b>[Karmik Retro Mührü]:</b> <i>İçsel bilgelik! Çocuk dışarıdan gelen kalıpları değil, kendi içinden gelen inancı ve felsefeyi önemser. Büyüme, kendi iç dünyasını keşfettikçe gerçekleşir.</i>",
    "Satürn": "📝 <b>[Karmik Retro Mührü]:</b> <i>Ağır Karmik Borç! Otorite figürleriyle ve sorumluluklarla ilgili geçmişten gelen bir sınav taşınır. Çocuk, kuralları dışarıdan değil kendi içinden öğrenerek olgunlaşır.</i>",
    "Uranüs": "📝 <b>[Karmik Retro Mührü]:</b> <i>İçsel devrim! İsyankar enerji dışarıya değil, kendi iç dünyasındaki kalıplara karşı çalışır. Çocuk, özgürlüğünü dışarıdan izin alarak değil, içinden keşfederek bulur.</i>",
    "Neptün": "📝 <b>[Karmik Retro Mührü]:</b> <i>Gizli illüzyonlar! Sezgileri çok açıktır ancak hayal dünyasına kaçma eğilimi olabilir. Rüyaları ve iç sesi, çocuğa en doğru yolu gösterir.</i>",
    "Plüton": "📝 <b>[Karmik Retro Mührü]:</b> <i>Yeraltı simyası! Güç savaşları ve derin korkular en içte saklıdır. Çocuk, iç dünyasıyla yüzleştikçe sessizce ve güçlenerek dönüşür.</i>",
    "Chiron": "📝 <b>[Karmik Retro Mührü]:</b> <i>Kadim yara! Şifa önce kendi içine yönelmelidir. Çocuk, kendini iyileştirdikçe çevresindekilere de şifa verir; en derin yarası, en büyük bilgeliğinin kaynağıdır.</i>",
    "Juno": "📝 <b>[Karmik Retro Mührü]:</b> <i>Karmik eş kontratı! Geçmişten gelen bir bağlılık sözleşmesi taşınır. Çocuk, sadakati yüzeysel kurallarla değil, içinden gelen derin bir bağlılıkla deneyimler.</i>",
    "Ceres": "📝 <b>[Karmik Retro Mührü]:</b> <i>İçsel beslenme! Şefkat beklerken önce kendi kendine yetmeyi öğrenmesi gereken özel bir kadersel döngü. Kendini beslemeyi öğrendikçe, sevgiyi de doyasıya alır.</i>",
    "Lilith": "📝 <b>[Karmik Retro Mührü]:</b> <i>Gölgenin inzivası! Bastırılmış duygular ve özgür ruh, dışarıya değil iç dünyaya yönelmiştir. Çocuk, karanlık yönlerini kabul ettikçe otantik kimliğini bulur.</i>"
}
...
_ANNE_REHBER_DICTS = _load_all_ext_dicts("FBST_ANNE_REHBER.py")
DUYGUSAL_IHTIYAC_AY = _ANNE_REHBER_DICTS.get("DUYGUSAL_IHTIYAC_AY", {})
SAKINLESME_AY = _ANNE_REHBER_DICTS.get("SAKINLESME_AY", {})
GUVEN_ORTAMI_4EV = _ANNE_REHBER_DICTS.get("GUVEN_ORTAMI_4EV", {})
ANNE_ROLU_ZORLUK = _ANNE_REHBER_DICTS.get("ANNE_ROLU_ZORLUK", {})
OGRENME_MOTIVASYON_MERKUR = _ANNE_REHBER_DICTS.get("OGRENME_MOTIVASYON_MERKUR", {})
EGITIM_3EV = _ANNE_REHBER_DICTS.get("EGITIM_3EV", {})
BESLENME_RUTIN_AY = _ANNE_REHBER_DICTS.get("BESLENME_RUTIN_AY", {})
OZGURLUK_SINIR_SATURN = _ANNE_REHBER_DICTS.get("OZGURLUK_SINIR_SATURN", {})
YAS_DONEMLERI = _ANNE_REHBER_DICTS.get("YAS_DONEMLERI", {})
ELEMENT_UYUM_ANNE_COCUK = _ANNE_REHBER_DICTS.get("ELEMENT_UYUM_ANNE_COCUK", {})
OZEL_BAG_ACI_TEMA = _ANNE_REHBER_DICTS.get("OZEL_BAG_ACI_TEMA", {})
GUNES_AY_UYUM_OZET = _ANNE_REHBER_DICTS.get("GUNES_AY_UYUM_OZET", {})
