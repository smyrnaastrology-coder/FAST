    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(children: [
          ...
          const Text('EVRENLE SORU ANININ DİLİ', style: TextStyle(color: Color(0xFFa898c0), fontSize: 9, letterSpacing: 2)),
        ]), centerTitle: true,
      ),
      body: Column(children: [
        Padding(padding: const EdgeInsets.all(8), child: Row(children: [
          Expanded(child: Text('📍 $lat, $lon', style: const TextStyle(color: Color(0xFFa898c0), fontSize: 11))),
        ...
        Padding(padding: const EdgeInsets.all(8), child: Row(children: [
          Expanded(child: TextField(controller: _ctrl, decoration: InputDecoration(hintText: 'Sorunuz — muhabbet gibi yaz', filled:true, fillColor: Colors.white, border: OutlineInputBorder(borderRadius: BorderRadius.circular(14))), style: const TextStyle(color: Colors.black), onSubmitted: (_)=> _ask())),
